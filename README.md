...
- Se uso una paleta de colores lilas
- La tipografía usada es la Montserrat

## Uso de git
El uso de git fue constante, con commits frecuentes, documentando el avance del proyecto y los arreglos que se hicieron